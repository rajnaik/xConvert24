...
test('Mine #11 — /stats/ — diamond gem or Mined visible', async ({ page }) => {
  ...
  expect(gemVisible || minedVisible, 'Expected diamond gem or Mined ✓ to be visible on /stats/').toBe(true);
});
