...
test('Mine #9 — /achievements/ — diamond gem or Mined visible', async ({ page }) => {
  ...
  expect(gemVisible || minedVisible, 'Expected diamond gem or Mined ✓ to be visible on /achievements/').toBe(true);
});
