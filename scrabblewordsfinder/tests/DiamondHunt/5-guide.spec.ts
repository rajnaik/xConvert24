...
test('Mine #5 — /guide/ — diamond gem or Mined visible', async ({ page }) => {
  ...
  expect(gemVisible || minedVisible, 'Expected diamond gem or Mined ✓ to be visible on /guide/').toBe(true);
});
