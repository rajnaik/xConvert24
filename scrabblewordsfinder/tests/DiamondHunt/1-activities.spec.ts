...
test('Mine #1 — /activities/ — diamond gem or Mined visible', async ({ page }) => {
  ...
  expect(gemVisible || minedVisible, 'Expected diamond gem or Mined ✓ to be visible on /activities/').toBe(true);
});
