...
test('Mine #13 — /blog/beginner-scrabble-strategy/ — diamond gem or Mined visible', async ({ page }) => {
  ...
  expect(gemVisible || minedVisible, 'Expected diamond gem or Mined ✓ to be visible on /blog/beginner-scrabble-strategy/').toBe(true);
});
