...
|---|---------|--------|--------------|---------|
| 1 | Monthly Snapshot Automation | 2h | Existing snapshot table | v1.21.0 |
| 2 | Rating Changes & Movers | 3h | Snapshots populated | v1.21.0 |
| 3 | Player Career Timelines | 4h | Multiple snapshots | v1.21.1 |
| 4 | Country Statistics | 3h | Rankings data | v1.21.1 |
| 5 | Records & Milestones | 3h | Snapshots + rankings | v1.21.2 |
| 6 | Tournament History & Results | 4h | Tournaments table | v1.21.2 |
| 7 | Player Detail Pages | 5h | All above | v1.21.3 |
| 8 | Analytics Dashboard (public) | 5h | All above | v1.21.3 |
| 9 | Historical Ranking Graphs | 4h | Snapshots + charting | v1.21.4 |
| 10 | Public API v2 (history endpoints) | 3h | All above | v1.21.4 |
